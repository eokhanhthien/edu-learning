		...
		<div class="col-md-8">
			<div class="row">
				<div class="col-md-3">
					...
					<div class="row payment-gateway chuyenkhoan" onclick="selectedPaymentGateway('chuyenkhoan')">
						<div class="col-12">
							<img class="tick-icon chuyenkhoan-icon" src="<?php echo base_url('assets/payment/tick.png'); ?>">
							<img class="payment-gateway-icon" src="<?php echo base_url('assets/payment/chuyenkhoan.jpg'); ?>">
						</div>
					</div>
				...
				<div class="col-md-8">
					...
					<div class="w-100 float-left">
						<form action="<?php echo site_url('home/chuyenkhoan_checkout'); ?>" method="post" class="chuyenkhoan-form form">
							<hr class="border mb-4">
							<input type="hidden" name="total_price_of_checking_out" value="<?php echo $total_price_of_checking_out; ?>">
							<button type="submit" class="payment-button float-right">Hoàn Thành</button>
						</form>
...
<script type="text/javascript">
	function selectedPaymentGateway(gateway) {
		if (gateway == 'chuyenkhoan') {
			
			$(".payment-gateway").css("border", "2px solid #D3DCDD");
			$('.tick-icon').hide();
			$('.form').hide();
			
			$(".chuyenkhoan").css("border", "2px solid #00D04F");
			$('.chuyenkhoan-icon').show();
			$('.chuyenkhoan-form').show();
