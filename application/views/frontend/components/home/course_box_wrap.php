        ...
        <a href="<?= site_url('home/course/' . rawurlencode(slugify($course['title'])) . '/' . $course['id']); ?>" class="has-popover">
            <div class="course-box">
                <div class="course-image">
                    <img src="<?= $this->crud_model->get_course_thumbnail_url($course['id']); ?>" alt="" class="img-fluid">
                </div>
                <div class="course-details">
                    ...
                    <div class="d-block">
                        ...
                        <?php if ($course['is_free_course'] == 1) : ?>
                            <p class="price text-right d-inline-block float-right"><?= site_phrase('free'); ?></p>
                        <?php else : ?>
                            <?php if ($course['discount_flag'] == 1) : ?>
                                <p class="price text-right d-inline-block float-right"><small><?= currency($course['price']); ?></small><?= currency($course['discounted_price']); ?></p>
                            <?php else : ?>
                                <p class="price text-right d-inline-block float-right"><?= currency($course['price']); ?></p>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="webui-popover-content">
            <div class="course-popover-content">
                ...
                <div class="what-will-learn">
                    <ul>
                        <?php $outcomes = json_decode($course['outcomes']) ?>
