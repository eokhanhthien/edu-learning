  ...
  <ul class="mobile-main-nav">
    ...
    <li class="has-children">
      <a href="">
        ...
        <span> <img alt="Danh mục" src="<?php echo base_url('uploads/danh_muc.svg')?>" data-src="<?php echo base_url('uploads/danh_muc.svg')?>" width="18px" height="18px" class="mr-1 lazyload" style="margin-bottom: 1px">DANH MỤC</span>
