...
<section class="menu-area">
    <div class="container-xl">
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-light" style="flex-wrap: nowrap">

                    <ul class="mobile-header-buttons w-100">
                        <li><a class="mobile-nav-trigger js-menu menu-toggle" href="#mobile-primary-nav">Menu<span></span></a></li>
