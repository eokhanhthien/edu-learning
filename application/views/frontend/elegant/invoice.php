                    ...
                    <div style="background: #eceff4;padding: 1.5rem;">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="text-right small"><span class="gry-color small"><?php echo site_phrase('purchase_date'); ?>:</span> <span class=" strong"><?php echo date('D, d-M-Y', $payment_info['date_added']); ?></span><br><?php echo site_phrase('status'); ?>:<strong> <?php echo $payment_info['status']; ?></strong></td>
						   </tr>
                        </table>
