				...
				<div class="box_detail">
					...
					<?php if ($course_details['is_free_course'] == 1):
						...
						<?php
							...
							?>
							<a href="<?php echo site_url('home/lesson/'.slugify($course_details['title']).'/'.$course_details['id']); ?>" class="btn_1 full-width outline"><?php echo site_phrase('start_lesson'); ?></a>
						<?php }?>
						<?php else: ?>
						<a href="javascript:;" class="btn_1 full-width" onclick="dangkyhoc('<?php echo $course_details['id'];?>')" style="background: green;" >Đăng Ký Học</a>
						<div class="hidden" id="form_dangkyhoc">
							
							
							
							<form action="<?php echo site_url('home/dang_ky_ngay');?>" method="post" autocomplete="off">
								<div class="form-group">
									<span class="input">
										<input class="input_field" type="text" name="hoten" required="">
										<input type="hidden" value="<?php echo $course_details['title'].'('.$course_details['id'].')';?>" name="khoahoc" required="">
										<label class="input_label">
											<span class="input__label-content">Họ Tên</span>
										</label>
									</span>
									...
									<span class="input">
										...
										<label class="input_label">
											<span class="input__label-content">Số điện thoại</span>
										</label>
									</span>
								...
								<button type="submit" class="btn_1 rounded full-width add_top_30" style="    background: #e60101;">Đăng ký</button>
							</form>
