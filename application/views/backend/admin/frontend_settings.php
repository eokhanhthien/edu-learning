        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="thongtin_chuyenkhoan">Thông tin chuyển khoản</label>
                        <textarea name="thongtin_chuyenkhoan" id = "thongtin_chuyenkhoan" class="form-control" rows="5"><?php echo get_frontend_settings('thongtin_chuyenkhoan'); ?></textarea>
                    </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    initSummerNote(['#about_us', '#terms_and_condition', '#privacy_policy', '#thongtin_chuyenkhoan', '#cookie_policy']);
  });
</script>