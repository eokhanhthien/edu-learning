...
<form action="<?php echo site_url('admin/quiz_questions/'.$param3.'/edit/'.$param2); ?>" method="post" id = 'mcq_form'>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control title-question" placeholder="Nhập tên câu hỏi" type="text" name="title" id="title" required>
    ...
    <div class="form-group" id='multiple_choice_question'>
        ...
        <div class="input-group">
            ...
            <div class="input-group-append" style="padding: 0px"><button type="button" class="btn btn-secondary btn-sm pull-right" name="button" onclick="showOptions(jQuery('#number_of_options').val())" style="border-radius: 0px;"><i class="fa fa-plus"></i> Tạo</button></div>
        </div>
    </div>
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <span class="input-group-text">
                        <input type='radio' name = "correct_answers[]" value = <?php echo ($i+1); ?> <?php if(in_array(($i+1), $correct_answers)) echo 'checked'; ?>>
                    </span>
                </div>
            </div>
        </div>
