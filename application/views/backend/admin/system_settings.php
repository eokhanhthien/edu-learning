            ...
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form class="required-form" action="<?php echo site_url('admin/system_settings/system_update'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="slogan_top"><?php echo get_phrase('slogan_top'); ?></label>
                            <textarea name="slogan_top" id = "slogan_top" class="form-control" rows="5"><?php echo get_settings('slogan_top');  ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="slogan"><?php echo get_phrase('slogan footer'); ?><span class="required">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="zalo"><?php echo get_phrase('zalo'); ?></label>
                            <input type="text" name = "zalo" id = "zalo" class="form-control" value="<?php echo get_settings('zalo');  ?>">
                        </div>

                        <div class="form-group">
                            <label for="fanpage"><?php echo get_phrase('fanpage'); ?></label>
                            <input type="text" name = "fanpage" id = "fanpage" class="form-control" value="<?php echo get_settings('fanpage');  ?>">
                        </div>

                        <div class="form-group">
                            <label for="maps"><?php echo get_phrase('maps'); ?></label>
                            <input type="text" name = "maps" id = "maps" class="form-control" value="<?php echo get_settings('maps');  ?>">
                        </div>
