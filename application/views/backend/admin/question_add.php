<form action="<?php echo site_url('admin/quiz_questions/'.$param2.'/add'); ?>" method="post" id = 'mcq_form'>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control title-question" placeholder="Nhập tên câu hỏi" type="text" name="title" id="title" required></textarea>
    </div>
    <div class="form-group" id='multiple_choice_question'>
        ...
        <div class="input-group">
            <input type="number" placeholder="Nhập số phương án trả lời" value="4"  class="form-control" name="number_of_options" id="number_of_options" data-validate="required" data-message-required="Value Required" min="0">
            <div class="input-group-append" style="padding: 0px">
                 <button type="button" class="btn btn-secondary btn-sm pull-right" name="button" onclick="showOptions(jQuery('#number_of_options').val())" style="border-radius: 0px;"><i class="fa fa-plus"></i> Tạo</button>
            </div>
        </div>

    </div>
    <div class="text-center">
        <button class = "btn btn-success" id = "submitButton" type="button" name="button" data-dismiss="modal"><i class="fa fa-save"></i> <?php echo get_phrase('submit'); ?></button>
    </div>
</form>
