...
<div class="left-side-menu left-side-menu-detached">
	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<li class="side-nav-item <?php if ($page_name == 'dangkyhoc') echo 'active'; ?>">
			<a href="<?php echo site_url('admin/dangkyhoc'); ?>" class="side-nav-link">
				<i class="dripicons-user-id"></i>
				<span>Đăng Ký Học</span>
			</a>
		</li>

		<li class="side-nav-item <?php if ($page_name == 'exams' || $page_name == 'exam_categories') echo 'active'; ?>">
				<a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'exams' || $page_name == 'exam_categories') : ?> active <?php endif; ?>">
					<i class="dripicons-blog"></i>
					<span> Đề thi </span>
					<span class="menu-arrow"></span>
				</a>
				<ul class="side-nav-second-level" aria-expanded="false">
					<li class="<?php if ( $page_name == 'exam_categories') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/exam_categories'); ?>">Danh mục loại đề thi</a>
					</li>
					<li class="<?php if ($page_name == 'exams') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/exams'); ?>">Quản lý đề thi</a>
					</li>
				</ul>
			</li>
		...
		<li class="side-nav-item <?= active_on($page_name == 'experts') ?>">
			<a href="<?= site_url('admin/experts'); ?>" class="side-nav-link <?= active_on($page_name == 'experts') ?>">
				<i class="dripicons-user-group"></i>
				<span><?= get_phrase('experts'); ?></span>
			</a>
		</li>

		<li class="side-nav-item <?= active_on($page_name == 'course_expert') ?>">
			<a href="<?= site_url('admin/course_expert'); ?>" class="side-nav-link <?= active_on($page_name == 'course_expert') ?>">
				<i class="dripicons-user-group"></i>
				<span>Chuyên gia - khóa học</span>
			</a>
		</li>
		...
		<?php endif; ?>
		<?php if (has_permission('cat_new')) : ?>
			<li class="side-nav-item">
				<a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'cat_new' || $page_name == 'list_cat_new') : ?> active <?php endif; ?>">
					<i class="dripicons-box"></i>
					<span> Tin Tức </span>
					<span class="menu-arrow"></span>
				</a>
				<ul class="side-nav-second-level" aria-expanded="false">
					<li class="<?php if ($page_name == 'news') echo 'active'; ?>"> <a href="<?php echo site_url('admin/news'); ?>">Bài viết</a> </li>
					<li class="<?php if ($page_name == 'cat_new') echo 'active'; ?>"> <a href="<?php echo site_url('admin/cat_new'); ?>">Thế loại</a> </li>
				</ul>
			</li>
		<?php endif; ?>
			...
			<li class="side-nav-item  <?php if ($page_name == 'system_settings' || $page_name == 'frontend_settings' || $page_name == 'payment_settings' || $page_name == 'smtp_settings' || $page_name == 'manage_language' || $page_name == 'about' || $page_name == 'themes') : ?> active <?php endif; ?>">
				...
				<ul class="side-nav-second-level" aria-expanded="false">
					...
					<li class="<?php if ($page_name == 'banner') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/banner'); ?>"><?php echo 'Banner'; ?></a>
					</li>
					<li class="<?php if ($page_name == 'tieuchi') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/tieuchi'); ?>"><?php echo 'Tiêu Chí'; ?></a>
					</li>
					<li class="<?php if ($page_name == 'menu') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/menu'); ?>"><?php echo 'Menu'; ?></a>
					</li>
