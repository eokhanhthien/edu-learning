...
<form action="<?php echo site_url('admin/quizes/'.$param3.'/edit/'.$param2); ?>" method="post">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="number" min="1" name="duration" id="duration" placeholder="Nhập thời gian làm bài thi: 10 phút"  value="<?php echo $quiz_details['duration']; ?>"  required>
    </div>
    <div class="form-group">
