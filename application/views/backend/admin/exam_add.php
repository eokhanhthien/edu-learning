...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> Tạo đề thi</h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
        ...
        <div class="card">
            <div class="card-body">
              <div class="col-lg-12">
                ...
                <form class="required-form" action="<?php echo site_url('admin/exams/add'); ?>" method="post">
                    <div class="form-group">
                        <label for="title">Tiêu đề</label>
                        <input class="form-control" type="text" placeholder="Nhập tên đề thi" name="title" id="title" required>
                    </div>
                    <div class="form-group">
